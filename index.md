I am passionate about developing efficient machine learning and deep learning algorithms to solve real-world challenges in natural language processing (NLP) and natural language understanding (NLU). I completed my PhD in Computer Science at Worcester Polytechnic Institute (WPI) in June 2021 under the guidance of Professor [Elke Rundensteiner](https://www.wpi.edu/people/faculty/rundenst) and Professor [Emmanuel Agu](https://www.wpi.edu/people/faculty/emmanuel). My doctoral research focused on text classification using machine learning, deep transfer learning, and neural NLP techniques, including emotion detection and embedding learning via fine-tuned transformer architectures. Before that, I received my Master in Computer Science from University of Alberta in Canada. 

Currently, I work as a Senior Data Scientist at Walmart Global Tech, where I apply and advance cutting-edge NLP methods in production. My recent work includes fine-tuning large language models (LLMs) for responsible AI in product safety, building retrieval-augmented generation (RAG)-based conversational agents for customer support, training deep learning models for product comparison and QA, and developing robust RoBERTa/BERT-based models for intent detection and entity recognition in e-commerce search-to-cart pipelines.
